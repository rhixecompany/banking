...
ALTER TABLE "banks" ADD CONSTRAINT "banks_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recipients" ADD CONSTRAINT "recipients_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "banks_user_id_idx" ON "banks" USING btree ("userId");--> statement-breakpoint
CREATE INDEX "banks_sharable_id_idx" ON "banks" USING btree ("sharable_id");--> statement-breakpoint
CREATE INDEX "recipients_user_id_idx" ON "recipients" USING btree ("userId");--> statement-breakpoint
