...
CREATE INDEX "banks_dwolla_customer_idx" ON "banks" USING btree ("dwolla_customer_url");--> statement-breakpoint
...
CREATE INDEX "transactions_receiver_bank_idx" ON "transactions" USING btree ("receiver_bank_id");--> statement-breakpoint
