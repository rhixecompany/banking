...
See the `flowstudio-power-automate-mcp` skill's **connection-references.md** reference for the full connection reference structure.

---

## Step 3 — Build the Flow Definition

Construct the definition object. See [flow-schema.md](references/flow-schema.md) for the full schema and these action pattern references for copy-paste templates:
...
> See [build-patterns.md](references/build-patterns.md) for complete, ready-to-use flow definitions covering Recurrence+SharePoint+Teams, HTTP triggers, and more.
