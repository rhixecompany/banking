...
> Source: [Billing rates and management](https://learn.microsoft.com/en-us/microsoft-copilot-studio/requirements-messages-management) Estimator: [Microsoft agent usage estimator](https://microsoft.github.io/copilot-studio-estimator/) Licensing Guide: [Copilot Studio Licensing Guide](https://go.microsoft.com/fwlink/?linkid=2320995)
