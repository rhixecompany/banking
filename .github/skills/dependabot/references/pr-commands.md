...
> **Deprecation Notice (January 27, 2026):** The following commands have been removed: `@dependabot merge`, `@dependabot squash and merge`, `@dependabot cancel merge`, `@dependabot close`, and `@dependabot reopen`. Use GitHub's native UI, CLI (`gh pr merge`), API, or auto-merge feature instead.
