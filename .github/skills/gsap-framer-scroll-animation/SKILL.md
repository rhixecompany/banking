...
> **Design Companion:** This skill provides the _technical implementation_ for scroll-driven motion. For the _creative philosophy_, design principles, and premium aesthetics that should guide **how** and **when** to animate, always cross-reference the **premium-frontend-ui** skill. Together they form a complete approach: premium-frontend-ui decides the **what** and **why**; this skill delivers the **how**.
...
tl.from(".title", { opacity: 0, y: 60 }).from(".img", {
  scale: 0.85
});
```
