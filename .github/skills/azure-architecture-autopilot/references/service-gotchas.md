...
>
> This mapping is complex and subject to change, so always fetch and verify MS Docs when configuring Monitor PE: https://learn.microsoft.com/en-us/azure/azure-monitor/logs/private-link-configure
...
> These rules are a **default selection guide** reflecting current MS recommendations. Azure product relationships can change, so check MS Docs when uncertain.
