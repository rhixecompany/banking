...
If **no files** from these directories were modified, call `noop` with the message: "No agent, instruction, skill, or workflow files were changed in this PR — no duplicate check needed."
