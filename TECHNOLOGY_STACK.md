...
**Project Path:** `projects/Banking` **Generated:** 2026-07-28 **Status:** Active (Fintech Application)
...
| **Linting** | eslint, @eslint/_, @typescript-eslint/_, eslint-plugin-\*, eslint-config-next, eslint-config-prettier, eslint-formatter-compact |
