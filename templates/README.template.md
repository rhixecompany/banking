...
- If a change touches > 3 files, create a plan in `.opencode/commands/` named `<short-kebab-task>.plan.md` before implementing. See `.opencode/instructions/09-plan-file-standards.md` for required sections.
