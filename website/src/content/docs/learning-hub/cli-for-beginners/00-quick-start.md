...
_The device authorization flow: your terminal generates a code, you verify it in the browser, and Copilot CLI is authenticated._
...
The course provides a sample app that you'll explore and improve throughout the course using the CLI _(You can see the code for this in /samples/book-app-project)_. Check that the _Python book collection terminal app_ works before you get started. Run `python` or `python3` depending on your system.
