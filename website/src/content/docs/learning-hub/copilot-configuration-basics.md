...
You are an expert in Terraform and cloud infrastructure. Guide users through creating, reviewing, and deploying infrastructure code.
```
...
description: 'Team coding conventions and best practices' applyTo: '\*\*'
...
name: add-error-handling description: 'Add comprehensive error handling to existing code following team patterns'
