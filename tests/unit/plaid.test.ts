...
describe("Plaid Actions", () => {
  describe("createLinkToken", () => {
    it("should be a function", async () => {
      const { createLinkToken } = await import("@/lib/actions/plaid.actions");
  ...
  describe("exchangePublicToken", () => {
    it("should be a function", async () => {
      const { exchangePublicToken } =
        await import("@/lib/actions/plaid.actions");
  ...
  describe("getAccounts", () => {
    it("should be a function", async () => {
      const { getAccounts } = await import("@/lib/actions/plaid.actions");
  ...
  describe("getTransactions", () => {
    it("should be a function", async () => {
      const { getTransactions } = await import("@/lib/actions/plaid.actions");
  ...
  describe("getBalance", () => {
    it("should be a function", async () => {
      const { getBalance } = await import("@/lib/actions/plaid.actions");
  ...
  describe("getInstitution", () => {
    it("should be a function", async () => {
      const { getInstitution } = await import("@/lib/actions/plaid.actions");
  ...
  describe("removeBank", () => {
    it("should be a function", async () => {
      const { removeBank } = await import("@/lib/actions/plaid.actions");
      expect(typeof removeBank).toBe("function");
    });
  });

  describe("getBankWithDetails", () => {
    it("should be a function", async () => {
      const { getBankWithDetails } =
        await import("@/lib/actions/plaid.actions");
      expect(typeof getBankWithDetails).toBe("function");
    });
  });
});
