...
- Phase 4b - npm Scripts: Modify bun run format and validation scripts (lint/type-check/test/format/build) to use repo bash scripts with echo then fallback to powershell using devops-engineer
