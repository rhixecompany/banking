...
**Project:** Banking **Type:** Fintech Web Application **Stack:** Next.js 16 + Drizzle + PostgreSQL + Plaid + Dwolla **Architecture Pattern:** Next.js App Router + Server Actions + DAL Layer **Entry Point:** API routes (`src/app/api/`) + Page routes (`src/app/`)
