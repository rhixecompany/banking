...
- [ ] 1.1 Enumerate all files in opencode.json instructions array
- [ ] 1.2 Read and audit every instruction file for overlaps, gaps, and stale metadata
- [ ] 1.3 Identify consolidation targets (plan workflow, commands ref, orphaned files)
- [ ] 1.4 Write audit findings to .opencode/commands/init-enhanced.md

## Phase 2: Consolidation & Standardization [COMPLETE]

- [ ] 2.1 Create .opencode/instructions/plan-workflow.md - MERGED from 08, 09, 09-plan
- [ ] 2.2 Merge .opencode/instructions/06-commands-ref.md into 00-default-rules.md - DEPRECATED with redirect
- [ ] 2.3 Update all .opencode/instructions/\*.md files with lastReviewed: 2026-04-23
- [ ] 2.4 Add "Canonical source: AGENTS.md" header to instruction files

## Phase 3: Cursor & GitHub Instructions DRY [COMPLETE]

- [ ] 3.1 Reviewed and updated 11 .cursor/rules/\*.mdc files with canonical source header
- [ ] 3.2 Updated all cursor rules with AGENTS.md as canonical source
- [ ] 3.3 Reviewed and updated 8 .github/instructions/\*.md files
- [ ] 3.4 Added canonical source headers to github instructions

## Phase 4: Orphan Handling [COMPLETE]

- [ ] 4.1 Deprecated agents_quickstart.md - redirects to AGENTS.md
- [ ] 4.2 Verified morph-tools.md is unique tool-routing policy
- [ ] 4.3 Updated .opencode/tools/philosophy.md with consistent frontmatter
