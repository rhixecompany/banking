...
To create the AGENTS.md file, first analyze the codebase to:
...
A comprehensive AGENTS.md file that will guide Opencode to produce code that is perfectly compatible with your existing technology versions and follows your established patterns and architecture.
