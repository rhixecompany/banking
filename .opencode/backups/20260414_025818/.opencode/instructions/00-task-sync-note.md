...
Agents and humans working in this repo must coordinate changes. Before making multi-file edits, create a plan under `.opencode/plans/` and link to it in the PR description.
