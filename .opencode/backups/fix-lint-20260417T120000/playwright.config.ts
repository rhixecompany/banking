...
export default defineConfig({
  ...
  /* Run tests sequentially â€” app state is shared (auth, DB). */
  fullyParallel: false,
  ...
  /* Retry on CI only â€” no retries locally to surface real failures immediately */
  ...
  /* Always 1 worker â€” stateful app (auth sessions, shared DB). */
  workers: 1,
});
