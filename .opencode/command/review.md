...
If no arguments provided, review staged changes using `git diff --cached`. If argument is "recent", review changes since last commit using `git diff HEAD~1`. Otherwise, review the specified file(s) or directory.
