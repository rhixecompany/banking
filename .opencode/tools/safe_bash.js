/**
 * Enhanced Safe Bash Tool - Compiled CommonJS Version
 * Provides secure command execution with pattern-based blocking and audit logging
 * This is a local test shim for the testing environment
 * @version 2.0.0
 ...
 */
function checkPathTraversal(command) {
...
async function execute(args) {
  ...
  const allowlist = args.allowlist || false;
  ...
  // 4. Command passed all security checks
