...
**File:** `.tmp/sessions/{id}/component-{name}.md` **Purpose:** Detailed execution steps for the _current_ focus. **Content:**
...
[Cart] -> [Order Service] -> [Payment Gateway] -> [Inventory Service]
