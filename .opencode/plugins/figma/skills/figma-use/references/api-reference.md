...
const variable =
  await figma.variables.importVariableByKeyAsync("VARIABLE_KEY");
...
node.description =
  "A short summary of this component's purpose and usage.";
...
const interStyles = allFonts.filter(
  f => f.fontName.family === "Inter"
);
