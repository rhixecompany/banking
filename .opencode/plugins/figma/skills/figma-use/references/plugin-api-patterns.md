...
frame.y = 0;
frame.fills = [
  { type: "SOLID", color: { r: 0.98, g: 0.98, b: 0.99 } }
];
```
...
circle.resize(48, 48);
circle.fills = [
  { type: "SOLID", color: { r: 0.85, g: 0.87, b: 0.9 } }
];
```
...
const labelKey = component.addComponentProperty(
  "label",
  "TEXT",
  "Button"
);
const showIconKey = component.addComponentProperty(
  "showIcon",
  "BOOLEAN",
  true
);
