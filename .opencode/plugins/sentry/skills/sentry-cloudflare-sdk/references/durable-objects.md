...
> Minimum SDK: `@sentry/cloudflare` v8.0.0+ Durable Object instrumentation: v8.x+ `instrumentPrototypeMethods`: v10.x+ Workflow instrumentation: v10.x+ D1 instrumentation: v8.x+ Durable Object Storage instrumentation: v10.x+
