...
> OpenAI integration: `@sentry/nestjs` ≥10.28.0+ Vercel AI SDK integration: ≥10.6.0+ Anthropic integration: see platform docs Google GenAI integration: see platform docs
