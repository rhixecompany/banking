...
> **Note:** SDK versions and APIs below reflect Sentry docs at time of writing (sentry-go v0.43.0). Always verify against [docs.sentry.io/platforms/go/](https://docs.sentry.io/platforms/go/) before implementing.
