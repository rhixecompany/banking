...
> **Minimum SDK:** `io.sentry:sentry-android` ≥ 7.0.0 (≥ 8.0.0 recommended) **NDK support:** `io.sentry:sentry-android-ndk` (included in `sentry-android` BOM) **Languages:** Kotlin and Java — all examples in Kotlin with Java equivalents where they differ
