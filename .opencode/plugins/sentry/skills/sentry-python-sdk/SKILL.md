...
> **Note:** SDK versions and APIs below reflect Sentry docs at time of writing (sentry-sdk 2.x). Always verify against [docs.sentry.io/platforms/python/](https://docs.sentry.io/platforms/python/) before implementing.
