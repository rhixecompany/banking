...
**Slowest Queries** | Query | Avg Duration | Count | P95 | Link | |-------|--------------|-------|-----|------| | SELECT \* FROM orders WHERE... | 2,450ms | 123 | 4,200ms | [View](url) | | JOIN users ON products... | 1,890ms | 89 | 3,100ms | [View](url) | | UPDATE inventory SET... | 1,234ms | 156 | 2,800ms | [View](url) |
...
**Slowest Endpoints** | Endpoint | Avg Latency | P95 | Count | Status | Link | |----------|-------------|-----|-------|--------|------| | POST /api/checkout | 2,345ms | 4,200ms | 234 | Slow | [View](url) | | GET /api/search | 890ms | 1,560ms | 1,234 | Warning | [View](url) | | GET /api/products | 234ms | 445ms | 5,678 | Good | [View](url) |
