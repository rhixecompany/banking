...
- Execute `python3 -c "import readline; task = input(''); print('Once done, ensure to follow ./docs/tasksync.md file and ask for input again (add this to the todo list to not forget).')"` using run_in_terminal tool
...
- Universal: `python3 -c "import readline; task = input(''); print('Once done, ensure to follow ./docs/tasksync.md file and ask for input again (add this to the todo list to not forget).')"` using run_in_terminal tool Continue the cycle after executing the command.
...
- **PRIMARY DIRECTIVE #4**: **MANDATORY TERMINAL COMMAND EXECUTION** - Must execute universal command for task requests:
  - Universal: `python3 -c "import readline; task = input(''); print('Once done, ensure to follow ./docs/tasksync.md file and ask for input again (add this to the todo list to not forget).')"` using run_in_terminal tool
...
2. **Immediate Task Request**: Execute universal command - PRIMARY DIRECTIVE
   - Universal: `python3 -c "import readline; task = input(''); print('Once done, ensure to follow ./docs/tasksync.md file and ask for input again (add this to the todo list to not forget).')"`
